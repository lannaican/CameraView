...
import com.star.camera.listener.CaptureListener;
import com.star.camera.listener.ClickListener;
import com.star.camera.listener.ReturnListener;
import com.star.camera.listener.TypeListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private com.star.camera.TypeButton btn_confirm;         //确认按钮
    private com.star.camera.TypeButton btn_cancel;          //取消按钮
    private com.star.camera.ReturnButton btn_return;        //返回按钮
    ...
    private void initView() {
        ...
        //取消按钮
        btn_cancel = new com.star.camera.TypeButton(getContext(), com.star.camera.TypeButton.TYPE_CANCEL, button_size);
        ...
        //确认按钮
        btn_confirm = new com.star.camera.TypeButton(getContext(), com.star.camera.TypeButton.TYPE_CONFIRM, button_size);
        ...
        //返回按钮
        btn_return = new com.star.camera.ReturnButton(getContext(), (int) (button_size / 2.5f));
